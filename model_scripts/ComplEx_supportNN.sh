...
#SBATCH --output=/blue/daisyw/ma.haodi/ComplEx-Inject/logs/ComplEx_supportNN-NELL-1_shot-1.out
...
echo "starting job"
echo "train: NELL_One; test: NELL_One-single_relation; valid: NELL_One; rule: replacement path; mu: 0.1"
