#!/bin/bash
#SBATCH --job-name=ComplEx_NNE-FB237-1_shot-Test
#SBATCH --output=/blue/daisyw/ma.haodi/ComplEx-Inject/logs/FB237-few_shot/ComplEx_NNE-FB237-type_0-5_shot-1.out
#SBATCH --error=/blue/daisyw/ma.haodi/ComplEx-Inject/logs/FB237-few_shot/ComplEx_NNE-FB237-type_0-few_shot.err
